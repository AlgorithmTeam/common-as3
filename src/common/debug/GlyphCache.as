    ...
    public class GlyphCache
    {
        ...
        protected function getGlyph(charCode:int):Glyph
        {
            if(_glyphCache[charCode] == null)
            {
                ...
                newGlyph.bitmap = new BitmapData(_textField.textWidth + 1, _textField.textHeight + 4, true, 0x0);
        ...
        protected const _textFormat:TextFormat = new TextFormat("_typewriter", 12, 0xDDDDDD); 
